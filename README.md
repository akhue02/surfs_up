...
For more detail on the Python script and libraries used refer to the [Surf's Up Jupyter Notebook](https://github.com/akhue02/surfs_Up/blob/main/SurfsUp_Challenge.ipynb)
